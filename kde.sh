...
sudo pacman -S --noconfirm ark dolphin dolphin-plugins ffmpegthumbs gwenview kdegraphics-thumbnailers kdesdk-thumbnailers kfind konsole okular partitionmanager spectacle flatpak kwalletmanager
